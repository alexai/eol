...
<body>
<form method="post" action="add_item_type1.php" id="add_item" enctype="multipart/form-data">
<div align="center">
  <h2>增加单选题  </h2>
</div>
<div>
...
<div>请选择所属类别<br /><br />
	...
	请输入题干的文字<br /><br />
    <input name="item_type1_stem" type="text" class="length" id="item_type1_stem" class="length"/>
    <br />
    <br />
    请输入本题的分值
    <input name="item_type1_score" type="text" id="item_type1_score" onkeyup="value=value.replace(/[^\d]/g,'')" />
    <br />
    <br />
  ...
  <input name="add_op" type="button" value="增加答案选项" onclick=add_option("a1") />
</div>
<div class="space30"></div>
<div>请不要忘记选择正确的答案！如不选则默认为A。<br /><br />
</div>
