...
lhgchk.rules = [
	...
	{ name : 'paremail', required : true, type : 'email', warn : '请输入正确的Emial格式' },
	{ name : 'tel', required : true, type : 'phone', warn : '请输入正确的电话格式' }
];
...
<form method="post" id="rs" action="adduser.php">
		<fieldset>
			<legend>学 生 注 册</legend>
			<dl>
			...
			<dl>
				...
				<dd><input id="addr" name="addr" type="text" /></dd>
			</dl>
			<dl>
				<dt><label for="paremail">* 家长信箱：</label></dt>
				<dd><input id="paremail" name="paremail" type="text" /></dd>
			</dl>
			<dl>
